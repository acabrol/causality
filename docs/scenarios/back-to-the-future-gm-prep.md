...
One night, Doctor Emmett Brown reveals a plutonium-powered DeLorean that can cross time. The plutonium was stolen from Libyan terrorists, who track Doc and shoot him. Alice escapes in the DeLorean and is thrown back to 1955.
...
The Investigators must rebuild the causal chain that leads to Alice's birth, push George to stand up to Biff, preserve Lorraine's attraction to George, send Alice back to 1985 using lightning, and decide whether warning Doc Brown about his future death can merge without breaking the origin.
...
- If George and Lorraine do not kiss at the dance, Alice and the McFly siblings are erased from the final Now.
- George must confront Biff in a way that preserves the courtship and changes his own future confidence.
- Doc Brown can send Alice home with lightning because the DeLorean no longer has plutonium.
...
| 9 | Doc builds the DeLorean and steals plutonium. | The return mechanism exists because Doc survives long enough to build it. |
| 10 | Libyan terrorists shoot Doc in 1985. | This event motivates Alice's escape. |
| 11 | Alice escapes in the DeLorean and lands in 1955. | Alice becomes the causal intruder. |
...
| 18 | Lightning powers the DeLorean return. | This replaces plutonium as the return energy. |
...
flowchart LR
  ...
  TU08 --> TU09["TU09<br/>Doc builds DeLorean"]
  TU09 --> TU10["TU10<br/>Doc is shot"]
  TU10 --> TU11["TU11<br/>Alice reaches 1955"]
  ...
  TU17 --> TU18["TU18<br/>Lightning return"]
...
- Doctor Emmett Brown has created a DeLorean-based time machine.
- Doc has stolen plutonium and dangerous people are looking for him.
- Alice may be stranded in 1955 with no obvious way home.
...
| F04 | Dependency | Dependency: F03. George and Lorraine kiss at the dance. | Alice and her siblings can exist. | Family photo, fading siblings, restored body coherence. |
...
| F06 | Simple | Doc builds the DeLorean and obtains plutonium. | The time jump to 1955 becomes possible. | DeLorean, plutonium case, Doc's test notes. |
| F07 | Dependency | Dependency: F06. Libyan terrorists attack Doc. | Alice escapes to 1955. | Bullet impacts, dead Doc record, DeLorean jump trace. |
...
| F12 | Dependency | Dependency: F09 and F11. Lightning strikes the clock tower at the right moment. | Alice returns to 1985. | Weather record, clock tower damage, DeLorean energy trace. |
...
flowchart LR
  ...
  C01["C01 Simple<br/>George is passive"]:::condition --> F01["F01<br/>George fails to assert himself"]:::fact --> E01["E01<br/>Biff bullying"]:::evidence
  F01 --> C02["C02 Dependency<br/>Road accident"]:::dependency --> F02["F02<br/>Lorraine meets George"]:::fact --> E02["E02<br/>Family story"]:::evidence
  F02 --> C03["C03 Dependency<br/>Dance together"]:::dependency --> F03["F03<br/>Courtship anchor possible"]:::fact --> E03["E03<br/>Dance flyer"]:::evidence
  F03 --> C04["C04 Dependency<br/>Dance kiss"]:::dependency --> F04["F04<br/>Alice can exist"]:::fact --> E04["E04<br/>Family photo"]:::evidence
  F04 --> C05["C05 Dependency<br/>George remains passive"]:::dependency --> F05["F05<br/>Weak 1985 household"]:::fact --> E05["E05<br/>Adult Biff dominance"]:::evidence
  C06["C06 Simple<br/>Doc builds DeLorean"]:::condition --> F06["F06<br/>Time jump possible"]:::fact --> E06["E06<br/>DeLorean notes"]:::evidence
  F06 --> C07["C07 Dependency<br/>Doc attacked"]:::dependency --> F07["F07<br/>Alice escapes to 1955"]:::fact --> E07["E07<br/>Jump trace"]:::evidence
  F07 --> C08["C08 Dependency<br/>Road interference"]:::dependency --> F08["F08<br/>Lorraine likes Alice"]:::fact --> E08["E08<br/>Fading photo"]:::evidence
  F08 --> C09["C09 Dependency<br/>Alice finds Doc"]:::dependency --> F09["F09<br/>Lightning plan possible"]:::fact --> E09["E09<br/>Clock tower flyer"]:::evidence
  F08 --> C10["C10 Dependency<br/>George confronts Biff"]:::dependency --> F10["F10<br/>George becomes credible"]:::fact --> E10["E10<br/>Witnesses"]:::evidence
  F10 --> C11["C11 Dependency<br/>Dance kiss restored"]:::dependency --> F11["F11<br/>Alice stabilizes"]:::fact --> E11["E11<br/>Restored photo"]:::evidence
  F09 --> C12["C12 Dependency<br/>Lightning timed"]:::dependency
  F11 --> C12
  C12 --> F12["F12<br/>Alice returns to 1985"]:::fact --> E12["E12<br/>Clock tower damage"]:::evidence
  F12 --> C13["C13 Dependency<br/>Warning preserved"]:::dependency --> F13["F13<br/>Doc survives"]:::fact --> E13["E13<br/>Bulletproof vest"]:::evidence
  F10 --> C14["C14 Dependency<br/>Improved confidence merges"]:::dependency
  F13 --> C14
  C14 --> F14["F14<br/>Improved coherent 1985"]:::fact --> E14["E14<br/>Successful George"]:::evidence
```

## Special Rule: Fading Existence

The fading photo and Alice's unstable body are scenario tools for paradox pressure.

- When the parent-courtship chain is broken, Alice takes one temporary `-10` Willpower penalty.
- If George and Lorraine remain separated at the end of a scene that should move them closer, add one unresolved minor conflict to Alice.
...
|---|---:|---|---|
| 19 | 1 | d4 | Can Doc be warned without preventing Alice's trip? |
...
| 10 | 10 | d10 | Why did Alice flee into 1955? |
...
- Doc is saved in a way that prevents the original DeLorean trip.
...
6. Lightning powers the return to 1985.
7. Alice exists in the final Now.
8. Doc survives only if his survival does not prevent the time trip.
