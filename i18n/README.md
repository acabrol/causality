...
The official main language of this repository is **English**.

The game may be designed and drafted in French because that is the author's natural working language. However, all primary public documentation at the repository root and in `docs/` must be written in English. French drafts, translations, and original source material live under `i18n/fr/`.

Currently supported languages:

| Language | Path | Status |
|---|---|---|
| English | `/README.md`, `/docs/` | Official primary version |
| French | `/i18n/fr/` | Working language, original source, and translation area |

## Policy

- Keep English documentation as the canonical public version.
